...
--
-- Servidor: localhost
-- Tiempo de generación: 27-09-2018 a las 17:45:53
...
--
-- Estructura de tabla para la tabla `iti_assets`
--

CREATE TABLE `iti_assets` (
...
--
-- Volcado de datos para la tabla `iti_assets`
--

INSERT INTO `iti_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `iti_associations`
--

CREATE TABLE `iti_associations` (
...
--
-- Estructura de tabla para la tabla `iti_banners`
--

CREATE TABLE `iti_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_banner_clients`
--

CREATE TABLE `iti_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `iti_banner_tracks`
--

CREATE TABLE `iti_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `iti_categories`
--

CREATE TABLE `iti_categories` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `iti_categories`
--

INSERT INTO `iti_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 770, '2018-09-27 15:27:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 770, '2018-09-27 15:27:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\",\"foobar\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 770, '2018-09-27 15:27:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 770, '2018-09-27 15:27:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 770, '2018-09-27 15:27:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 770, '2018-09-27 15:27:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(9, 35, 1, 11, 12, 1, 'blog', 'com_content', 'Blog', 'blog', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 770, '2018-09-27 15:27:36', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_contact_details`
--

CREATE TABLE `iti_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_content`
--

CREATE TABLE `iti_content` (
...
--
-- Estructura de tabla para la tabla `iti_content_frontpage`
--

CREATE TABLE `iti_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `iti_content_rating`
--

CREATE TABLE `iti_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `iti_content_types`
--

CREATE TABLE `iti_content_types` (
...
--
-- Volcado de datos para la tabla `iti_content_types`
--

INSERT INTO `iti_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `iti_core_log_searches`
--

CREATE TABLE `iti_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `iti_extensions`
--

CREATE TABLE `iti_extensions` (
...
--
-- Volcado de datos para la tabla `iti_extensions`
--

INSERT INTO `iti_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"607483c2fa12c7004ac3afe72ea512be\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1538062668}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `iti_fields`
--

CREATE TABLE `iti_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_fields_categories`
--

CREATE TABLE `iti_fields_categories` (
...
--
-- Estructura de tabla para la tabla `iti_fields_groups`
--

CREATE TABLE `iti_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `iti_fields_values`
--

CREATE TABLE `iti_fields_values` (
...
--
-- Estructura de tabla para la tabla `iti_finder_filters`
--

CREATE TABLE `iti_finder_filters` (
...
--
-- Estructura de tabla para la tabla `iti_finder_links`
--

CREATE TABLE `iti_finder_links` (
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms0`
--

CREATE TABLE `iti_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms1`
--

CREATE TABLE `iti_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms2`
--

CREATE TABLE `iti_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms3`
--

CREATE TABLE `iti_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms4`
--

CREATE TABLE `iti_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms5`
--

CREATE TABLE `iti_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms6`
--

CREATE TABLE `iti_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms7`
--

CREATE TABLE `iti_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms8`
--

CREATE TABLE `iti_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_terms9`
--

CREATE TABLE `iti_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_termsa`
--

CREATE TABLE `iti_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_termsb`
--

CREATE TABLE `iti_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_termsc`
--

CREATE TABLE `iti_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_termsd`
--

CREATE TABLE `iti_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_termse`
--

CREATE TABLE `iti_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_links_termsf`
--

CREATE TABLE `iti_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `iti_finder_taxonomy`
--

CREATE TABLE `iti_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `iti_finder_taxonomy`
--

INSERT INTO `iti_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_finder_taxonomy_map`
--

CREATE TABLE `iti_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_finder_terms`
--

CREATE TABLE `iti_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_finder_terms_common`
--

CREATE TABLE `iti_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `iti_finder_terms_common`
--

INSERT INTO `iti_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `iti_finder_tokens`
--

CREATE TABLE `iti_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `iti_finder_tokens_aggregate`
--

CREATE TABLE `iti_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_finder_types`
--

CREATE TABLE `iti_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_languages`
--

CREATE TABLE `iti_languages` (
...
--
-- Volcado de datos para la tabla `iti_languages`
--

INSERT INTO `iti_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_menu`
--

CREATE TABLE `iti_menu` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `iti_menu`
--

INSERT INTO `iti_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `iti_menu_types`
--

CREATE TABLE `iti_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `iti_menu_types`
--

INSERT INTO `iti_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `iti_messages`
--

CREATE TABLE `iti_messages` (
...
--
-- Estructura de tabla para la tabla `iti_messages_cfg`
--

CREATE TABLE `iti_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `iti_modules`
--

CREATE TABLE `iti_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `iti_modules`
--

INSERT INTO `iti_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `iti_modules_menu`
--

CREATE TABLE `iti_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `iti_modules_menu`
--

INSERT INTO `iti_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `iti_newsfeeds`
--

CREATE TABLE `iti_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_overrider`
--

CREATE TABLE `iti_overrider` (
...
--
-- Estructura de tabla para la tabla `iti_postinstall_messages`
--

CREATE TABLE `iti_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `iti_postinstall_messages`
--

INSERT INTO `iti_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `iti_redirect_links`
--

CREATE TABLE `iti_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_schemas`
--

CREATE TABLE `iti_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `iti_schemas`
--

INSERT INTO `iti_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.8.9-2018-06-19');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_session`
--

CREATE TABLE `iti_session` (
...
--
-- Volcado de datos para la tabla `iti_session`
--

INSERT INTO `iti_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('dbd9ce70db82a63280ff3544a14fe7eb', 0, 0, '1538062691', 'joomla|s:996:\"\";', 770, '1830070');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_tags`
--

CREATE TABLE `iti_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `iti_tags`
--

INSERT INTO `iti_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 770, '2018-09-27 15:27:36', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_template_styles`
--

CREATE TABLE `iti_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `iti_template_styles`
--

INSERT INTO `iti_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `iti_ucm_base`
--

CREATE TABLE `iti_ucm_base` (
...
--
-- Estructura de tabla para la tabla `iti_ucm_content`
--

CREATE TABLE `iti_ucm_content` (
...
--
-- Estructura de tabla para la tabla `iti_ucm_history`
--

CREATE TABLE `iti_ucm_history` (
...
--
-- Estructura de tabla para la tabla `iti_updates`
--

CREATE TABLE `iti_updates` (
...
--
-- Estructura de tabla para la tabla `iti_update_sites`
--

CREATE TABLE `iti_update_sites` (
...
--
-- Volcado de datos para la tabla `iti_update_sites`
--

INSERT INTO `iti_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1538062670, ''),
...
--
-- Estructura de tabla para la tabla `iti_update_sites_extensions`
--

CREATE TABLE `iti_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `iti_update_sites_extensions`
--

INSERT INTO `iti_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Estructura de tabla para la tabla `iti_usergroups`
--

CREATE TABLE `iti_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `iti_usergroups`
--

INSERT INTO `iti_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `iti_users`
--
...
--
-- Volcado de datos para la tabla `iti_users`
--

INSERT INTO `iti_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(770, 'Super User', '1830070', '1830070@upv.edu.mx', '$2y$10$eDLQ4KApn1nsPMIP1VDWkOeJJXVGm3xpUuGGW65xNsn87r9qk1j0W', 0, 1, '2018-09-27 15:27:37', '2018-09-27 15:38:10', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_user_keys`
--

CREATE TABLE `iti_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `iti_user_notes`
--

CREATE TABLE `iti_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `iti_user_profiles`
--

CREATE TABLE `iti_user_profiles` (
...
--
-- Estructura de tabla para la tabla `iti_user_usergroup_map`
--

CREATE TABLE `iti_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `iti_user_usergroup_map`
--

INSERT INTO `iti_user_usergroup_map` (`user_id`, `group_id`) VALUES
(770, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_utf8_conversion`
--

CREATE TABLE `iti_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `iti_utf8_conversion`
--

INSERT INTO `iti_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `iti_viewlevels`
--

CREATE TABLE `iti_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `iti_viewlevels`
--

INSERT INTO `iti_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indices de la tabla `iti_assets`
--
ALTER TABLE `iti_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `iti_associations`
--
ALTER TABLE `iti_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `iti_banners`
--
ALTER TABLE `iti_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `iti_banner_clients`
--
ALTER TABLE `iti_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `iti_banner_tracks`
--
ALTER TABLE `iti_banner_tracks`
...
--
-- Indices de la tabla `iti_categories`
--
ALTER TABLE `iti_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `iti_contact_details`
--
ALTER TABLE `iti_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `iti_content`
--
ALTER TABLE `iti_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `iti_contentitem_tag_map`
--
ALTER TABLE `iti_contentitem_tag_map`
...
--
-- Indices de la tabla `iti_content_frontpage`
--
ALTER TABLE `iti_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `iti_content_rating`
--
ALTER TABLE `iti_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `iti_content_types`
--
ALTER TABLE `iti_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `iti_extensions`
--
ALTER TABLE `iti_extensions`
...
--
-- Indices de la tabla `iti_fields`
--
ALTER TABLE `iti_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `iti_fields_categories`
--
ALTER TABLE `iti_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `iti_fields_groups`
--
ALTER TABLE `iti_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `iti_fields_values`
--
ALTER TABLE `iti_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `iti_finder_filters`
--
ALTER TABLE `iti_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `iti_finder_links`
--
ALTER TABLE `iti_finder_links`
...
--
-- Indices de la tabla `iti_finder_links_terms0`
--
ALTER TABLE `iti_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms1`
--
ALTER TABLE `iti_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms2`
--
ALTER TABLE `iti_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms3`
--
ALTER TABLE `iti_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms4`
--
ALTER TABLE `iti_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms5`
--
ALTER TABLE `iti_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms6`
--
ALTER TABLE `iti_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms7`
--
ALTER TABLE `iti_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms8`
--
ALTER TABLE `iti_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_terms9`
--
ALTER TABLE `iti_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_termsa`
--
ALTER TABLE `iti_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_termsb`
--
ALTER TABLE `iti_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_termsc`
--
ALTER TABLE `iti_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_termsd`
--
ALTER TABLE `iti_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_termse`
--
ALTER TABLE `iti_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_links_termsf`
--
ALTER TABLE `iti_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `iti_finder_taxonomy`
--
ALTER TABLE `iti_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `iti_finder_taxonomy_map`
--
ALTER TABLE `iti_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `iti_finder_terms`
--
ALTER TABLE `iti_finder_terms`
...
--
-- Indices de la tabla `iti_finder_terms_common`
--
ALTER TABLE `iti_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `iti_finder_tokens`
--
ALTER TABLE `iti_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indices de la tabla `iti_finder_tokens_aggregate`
--
ALTER TABLE `iti_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `iti_finder_types`
--
ALTER TABLE `iti_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `iti_languages`
--
ALTER TABLE `iti_languages`
...
--
-- Indices de la tabla `iti_menu`
--
ALTER TABLE `iti_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `iti_menu_types`
--
ALTER TABLE `iti_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `iti_messages`
--
ALTER TABLE `iti_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `iti_messages_cfg`
--
ALTER TABLE `iti_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `iti_modules`
--
ALTER TABLE `iti_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `iti_modules_menu`
--
ALTER TABLE `iti_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `iti_newsfeeds`
--
ALTER TABLE `iti_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `iti_overrider`
--
ALTER TABLE `iti_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `iti_postinstall_messages`
--
ALTER TABLE `iti_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `iti_redirect_links`
--
ALTER TABLE `iti_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indices de la tabla `iti_schemas`
--
ALTER TABLE `iti_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `iti_session`
--
ALTER TABLE `iti_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indices de la tabla `iti_tags`
--
ALTER TABLE `iti_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `iti_template_styles`
--
ALTER TABLE `iti_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indices de la tabla `iti_ucm_base`
--
ALTER TABLE `iti_ucm_base`
...
--
-- Indices de la tabla `iti_ucm_content`
--
ALTER TABLE `iti_ucm_content`
...
--
-- Indices de la tabla `iti_ucm_history`
--
ALTER TABLE `iti_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `iti_updates`
--
ALTER TABLE `iti_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `iti_update_sites`
--
ALTER TABLE `iti_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `iti_update_sites_extensions`
--
ALTER TABLE `iti_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `iti_usergroups`
--
ALTER TABLE `iti_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `iti_user_keys`
--
ALTER TABLE `iti_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indices de la tabla `iti_user_notes`
--
ALTER TABLE `iti_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `iti_user_profiles`
--
ALTER TABLE `iti_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `iti_user_usergroup_map`
--
ALTER TABLE `iti_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `iti_viewlevels`
--
ALTER TABLE `iti_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `iti_assets`
--
ALTER TABLE `iti_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT de la tabla `iti_banners`
--
ALTER TABLE `iti_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_banner_clients`
--
ALTER TABLE `iti_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_categories`
--
ALTER TABLE `iti_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `iti_contact_details`
--
ALTER TABLE `iti_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_content`
--
ALTER TABLE `iti_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `iti_content_types`
--
ALTER TABLE `iti_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT de la tabla `iti_extensions`
--
ALTER TABLE `iti_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT de la tabla `iti_fields`
--
ALTER TABLE `iti_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_fields_groups`
--
ALTER TABLE `iti_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_finder_filters`
--
ALTER TABLE `iti_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_finder_links`
--
ALTER TABLE `iti_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_finder_taxonomy`
--
ALTER TABLE `iti_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `iti_finder_terms`
--
ALTER TABLE `iti_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_finder_types`
--
ALTER TABLE `iti_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_languages`
--
ALTER TABLE `iti_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `iti_menu`
--
ALTER TABLE `iti_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;

--
-- AUTO_INCREMENT de la tabla `iti_menu_types`
--
ALTER TABLE `iti_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `iti_messages`
--
ALTER TABLE `iti_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_modules`
--
ALTER TABLE `iti_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;

--
-- AUTO_INCREMENT de la tabla `iti_newsfeeds`
--
ALTER TABLE `iti_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_overrider`
--
ALTER TABLE `iti_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT de la tabla `iti_postinstall_messages`
--
ALTER TABLE `iti_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `iti_redirect_links`
--
ALTER TABLE `iti_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_tags`
--
ALTER TABLE `iti_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `iti_template_styles`
--
ALTER TABLE `iti_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `iti_ucm_content`
--
ALTER TABLE `iti_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_ucm_history`
--
ALTER TABLE `iti_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_updates`
--
ALTER TABLE `iti_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_update_sites`
--
ALTER TABLE `iti_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `iti_usergroups`
--
ALTER TABLE `iti_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `iti_users`
--
ALTER TABLE `iti_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=771;

--
-- AUTO_INCREMENT de la tabla `iti_user_keys`
--
ALTER TABLE `iti_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_user_notes`
--
ALTER TABLE `iti_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `iti_viewlevels`
--
ALTER TABLE `iti_viewlevels`
